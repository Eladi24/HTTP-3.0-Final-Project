...
def parse_arguments():
    ...
    parser_ack.add_argument('--version','-V', help='The quic version to be used', choices=['h3-27', 'h3-29', '1', '2'], default='1')
...
def ack_callback(packet, args=None):
    # TODO: Implement ACK mode
    # Currently test mode, just letting the packet through
    packet.accept()
    print("[*] Packet accepted")
